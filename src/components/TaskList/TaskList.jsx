...
const TaskList = () => {
  return (
    <div id="tasklist" className="h-[55%] overflow-x-auto flex justify-start items-center gap-5 flex-nowrap w-full py-5 mt-10">
      <div className="flex-shrink-0 h-full w-[300px] bg-red-400 rounded-xl">
          ...
          <p className="text-sm mt-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit rerum eligendi laudantium accusamus aperiam dolore dolorem fugiat dolorum maiores quas ea,
          </p>
      </div>
